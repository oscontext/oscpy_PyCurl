...
File:           oscq.py
Description:    This file is intended to serve as an ongoing base for pycurl
                based queries into the Open Source Context API.
Version:        0.0.2
Modify Date:    06 MAR 2022
"""
...
"""
Functions beginning with d_ are for use with domainsquery endpoint i.e. pDNS.
Functions beginning with b_ are for use with bgpevents endpoint i.i. pBGP.
Please don not call any of the __d or __b functions within your integration or
application.
"""

#Common object to pass to multiple API query types
class oscQuery:
    ...
    def __dquery(my_obj):
        ...
        qstring = urllib.parse.quote(my_obj.query)
        #Add the API Key
        ...
        headers = [
            ...
            'referer:osc_integration_libs_curl'
        ]

        buffer = BytesIO()
        res_curl = pycurl.Curl()
        res_curl.setopt(res_curl.URL, my_obj.url + '?q=' + qstring)
    ...
    #endpoint using PycURL. It includes the necessary logic to paginate using
